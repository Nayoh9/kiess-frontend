          ...
          >
            <div>
              ...
              <p className="w-1/2 text-xs max-tablet820px:w-3/4 max-tablet820px:text-sm">
                Les photos de vos matchs sont cachées derrière des cases. Pour
                les découvrir, rien de plus simple : Engagez la conversation,
          ...
          <div className=" w-1/2 max-tablet820px:w-tendencyTextWidth max-tablet820px:pl-20 max-mobile:w-3/4 max-mobile:pl-3">
            ...
            >
              ...
              <p className="w-3/4 text-xs max-tablet820px:text-sm max-mobile:w-fit">
                ...
                pour vous décrire, incluant vos passions, vos goûts, vos
                hobbies, vos envies et vos traits de personnalité. C'est la
                meilleure façon de le rendre attractif.
              </p>
            </motion.h1>
          </div>
        </article>
          ...
          <div className=" ml-3 w-1/2 max-tablet820px:ml-0 max-tablet820px:flex max-tablet820px:w-tendencyTextWidth max-tablet820px:flex-col max-tablet820px:pl-20 max-mobile:ml-0 max-mobile:w-3/4 max-mobile:pl-3">
            ...
            >
              ...
              <p className="w-2/3 text-xs max-tablet820px:text-sm max-mobile:w-fit">
                Vous recherchez votre âme sœur ou souhaitez vous faire de
                nouveaux amis ? Notre algorithme vous proposera les profils les
                plus attrayants. Testez également nos matchmaking ludiques, tels
                que "Les opposés s'attirent" où les profils avec le moins de
                points communs vous seront présentés, ainsi que d'autres types
                de jeux pour découvrir de nouvelles façons de faire des
                rencontres.
              </p>
            </motion.h1>
          </div>
