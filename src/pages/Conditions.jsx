          ...
          <article className="mb-40  ml-10 mr-10 w-fit text-conditionsFontSize text-blackTextColor">
            ...
            <div className="w-fit">
              ...
              <p>
                ...
                actions simplifiées dont le siège social est situé au 75 avenue
                de Soulac et qui est immatriculée sous le numéro XXX XXX XXX au
                Registre du
              </p>
              ...
              <p>
                ...
                lesquelles l’Utilisateur est autorisé à utiliser l’Application
              ...
              <p>
                ...
                Conditions. Par conséquent, en créant un Compte Utilisateur et
                en utilisant l’Application vous
              </p>
              <p>
              ...
              <p>
                ...
                l’ensemble de ces documents et à ne pas vous inscrire sur Kiess
                si vous n’êtes pas
              </p>
              <p>
            ...
            <ul className="ml-7 w-fit list-disc">
              <li>
                <p>
                  « Compte Utilisateur » ou « Profil de l’Utilisateur »
                  désignent l’espace spécifique à un Utilisateur sur lequel il
                  peut renseigner des informations sur sa personne, consulter et
              ...
              <li>
                <p>
                  « Plateforme » désigne la solution en ligne accessible à
                  partir de l’application Kiess disponible sur GooglePlay ou
                  Apple Store ;
                </p>
              </li>
              <li>
                <p>
                  « Matchs » désigne les personnes avec qui l’utilisateur se
                  verra proposer une rencontre
                </p>
              </li>
              <li>
                <p>
                  « Services » désignent l’ensemble des fonctionnalités offertes
                  à l’Utilisateur pour lui permettre de créer, modifier,
                  publier, partager son contenu.
                </p>
              </li>
              <li>
                <p>
            ...
            <div className="w-fit">
              ...
              <p>
                ...
                vous sera propre. Lors de la création de votre Compte
                Utilisateur nous vous demanderons de renseigner les informations
                suivantes :
              </p>
            </div>
            <ul className="ml-7 w-fit list-disc">
            ...
            <div className="w-fit">
              ...
              <p>
                Lors de la création de votre Compte Utilisateur, les
                informations communiquées doivent correspondre à votre propre
                identité et ne doivent en aucun cas être fausses ou erronées.
              </p>
              <p>
              ...
              <p>
                nous en avertir en nous contactant à l’adresse contact@Kiess.fr
                ou support@kiess.com.
              </p>
              <p>
              ...
              <p>
                ...
                créer, publier, partager du Contenu, de (ii) visionner le
                Contenu d’autres Utilisateurs (iii)
              </p>
            ...
            <ul className="ml-7 w-fit list-disc">
              <li>
                <p>
                  La fonctionnalité « Matchmaking » qui vous permet de
                  rechercher dans votre carnet de
                </p>
                <p>contacts téléphonique les personnes utilisant Kiess ;</p>
              </li>
              <li>
                <p>
                  Une fonctionnalité messagerie pour échanger entre
                  Utilisateurs;
                </p>
              </li>
            </ul>
            <div className="w-fit">
              ...
              <p>
                ...
                stockons. Néanmoins, si vous estimez qu’un Contenu est illicite
                ou inapproprié vous
              </p>
              <p>
                pouvez nous le signaler ou signaler l’Utilisateur qui en est
                l’auteur en cliquant sur l’onglet « signaler » dans les
                paramètres de la photo ou dans les paramètres du Profil de
                l’Utilisateur.
              </p>
              <p>
                Nous vous invitons notamment à nous signaler tout Contenu à
                caractère sexuel et/ou pédopornographique, appelant à la haine,
                au terrorisme, à la violence en général ou à l’égard d’un groupe
                de personnes en
              </p>
              <p>
              ...
              <p>
                Dans le cadre de l’utilisation de l’Application, vous vous
                engagez à vous conformer aux dispositions décrites dans les
                présentes Conditions générales d’utilisation et aux lois en
                vigueur. A ce titre vous vous
              </p>
            ...
            <ul className="ml-7 w-fit list-disc">
              ...
              <li>
                <p>
                  ...
                  les mesures que nous pourrions utiliser pour bloquer ou
              ...
              <li>
                <p>
                  Utiliser l’Application Kiess de manière trompeuse,
                  malveillante, discriminatoire, ou plus généralement de façon
                  illégale, par exemple en vous faisant passer pour quelqu’un
                  d’autre à des fins personnelles ou
                </p>
              ...
              <li>
                <p>
                  Nuire ou tenter de nuire à autrui ou à un groupe, notamment
                  par l’intimidation, le harcèlement, la promotion de contenus à
              ...
              <li>
                <p>
                  Utiliser les Services pour télécharger, transmettre,
                  distribuer, sauvegarder ou mettre à disposition
                  intentionnellement, par imprudence ou négligence tout Contenu
                  pouvant porter atteinte aux droits de
                </p>

                <p>
                  propriété intellectuelle des tiers, au droit à la vie privée,
                  à l’image, à la dignité et à l’honneur d’autrui, y compris
                  d’une personne décédée. A cet égard, veuillez noter que vous
                  êtes seul responsable du
                </p>

                <p>
                  Contenu que vous choisissez de partager sur l’Application, et
                  cela notamment lorsque ce Contenu représente d’autres
                  personnes. Nous vous recommandons de toujours vous assurer du
                  consentement{" "}
                </p>
            ...
            <div className="w-fit">
              ...
              <p>
                ...
                préavis, pour quelques raisons que ce soit et notamment en cas
                de :
              </p>
            </div>
            <ul className="ml-7 w-fit list-disc">
            ...
            <div className="w-fit">
              ...
              <p>
                ...
                non-exclusive, limitée et non-transférable, révocable, valable
                sur le monde entier et jusqu’à la suppression de votre Compte
                Utilisateur pour partager vos
              </p>
              <p>
                Contenus et interagir avec d’autres Utilisateurs uniquement.
              </p>
              <p>
              ...
              <p>
                ...
                écrite. Toute violation de cette obligation est constitutive
                d’une contrefaçon, sanctionnée notamment par les articles
                L.335-2 et suivants du Code de
              </p>
            ...
            <ul className="ml-7 w-fit list-disc">
              ...
              <li>
                <p>
                  ...
                  telle opération excède manifestement une utilisation normale
                  et à titre privé de
                </p>
                <p>l’Application ;</p>
              </li>
              ...
              <li>
                <p>
                  ...
                  constitutif de l’Application, notamment les informations
                  visibles de l’Application, les bases de données, les Services,
                  les programmes, les codes sources,
                </p>
                <p>
                  les algorithmes, les méthodes incorporées à l’Application ;
                </p>
              </li>
              ...
              <li>
                <p>
                  ...
                  tenter de perturber le bon fonctionnement de l’Application ;
                  ou mettre en œuvre des actions qui imposeraient une charge
            ...
            <div className="w-fit">
              ...
              <p>
                En utilisant Kiess vous serez amené à créer des Contenus dont
                vous pouvez être l’auteur et, le cas échéant, le titulaire des
            ...
            <ul className="ml-7 w-fit list-disc">
              <li>
                <p>
                  Aux autres Utilisateurs de reproduire et de partager le
                  Contenu sur WhatsApp, Facebook, Twitter, SnapChat et
                  Instagram, et plus généralement tout réseau social ou
                  application de messagerie qui pourraient
                </p>
                <p>être interfacées avec Kiess ;</p>
              </li>
              <li>
                <p>
                  A Kiess Inc d’héberger, stocker, reproduire, modifier,
                  adapter, afficher, publier, éditer, distribuer et
                  sous-licencier tout ou partie du Contenu aux fins de la
                  fourniture des Services de l’Application à ses
                </p>
                <p>
            ...
            <p>
              ...
              conséquence nous ne vous offrons aucune garantie les concernant,
            ...
            <ul className="ml-7 w-fit list-disc">
              ...
              <li>
                <p>
                  ...
                  d’atteinte aux droits des tiers dans le cadre du
                  fonctionnement de l’Application Kiess ;
                </p>
              </li>
            ...
            <div className="w-fit">
              <p>
                ...
                données peut comporter des risques liés à l’absence de
                protection de certaines{" "}
              </p>
              <p>
                données contre des détournements éventuels et des risques de
                contamination par des virus. Aussi, la responsabilité de Kiess
                Inc ne pourra en aucun cas être retenue du fait de la perte ou
                l’altération de
              </p>
              ...
              <p>
                ...
                limiter la disponibilité de l’intégralité ou d’une partie de
                notre Plateforme pour des raisons
              </p>
              <p>
              ...
              <p>
                ...
                Libertés) ainsi qu’au Règlement UE 2016/679 du 27 avril 2016,
                dit Règlement Général sur la Protection des Données (RGPD).
              </p>
              <p>
                Pour obtenir davantage de détails concernant l’utilisation de
                vos données à caractère personnel et vos droits les concernant,
                nous vous recommandons de lire notre Politique de
                confidentialité.
              </p>
              <p>10 Modification des Conditions Générales d’Utilisation</p>
              <p>
                Kiess Inc se réserve la faculté de modifier ses CGU à tout
                moment. Dans ce cas, Kiess Inc publiera les nouvelles versions
                des CGU sur les pages de l’Application et alertera les
                Utilisateurs au moyen d’une
              </p>
              <p>
                fenêtre pop-up qui apparaîtra à l’ouverture de l’Application.
              </p>
              <p>11 Divers</p>
              <p>
                Dans l’hypothèse où la totalité ou une partie des dispositions
                des CGU serait considérée comme illégale, inopposable ou
                inapplicable par une décision de justice, les autres
                dispositions ou accords{" "}
              </p>
              <p>
                demeureront applicables, à la condition que l’économie générale
                du contrat n’en soit pas bouleversée. La disposition invalide
                sera remplacée par une disposition valable, se rapprochant le
                plus possible du but{" "}
              </p>
              <p>
                économique poursuivi par les Parties. Les présentes, ainsi que
                la Politique de confidentialité, correspondent à la totalité de
              ...
              <p>
                ...
                priorité à contacter Kiess Inc à contact@kiess.fr afin de
              ...
              <p>
                ...
                en ligne des litiges, facilitant le règlement indépendant par
                voie{" "}
              </p>
              <p>
              ...
              <p>
                ...
                différend non résolu par les voies indiquées ci-dessus sera
                soumis à la juridiction compétente correspondant au tribunal du
              ...
              <p>13.1 Achats</p>
              <p>
                Dans le Service, vous pouvez acheter, avec de l’argent du «
                monde réel », un droit limité, personnel, non transférable, non
                sous-licenciable et révocable d’utiliser de la monnaie
                virtuelle, mais sans s’y limiter, de
              </p>
              <p>
              ...
              <p>
                applicables. Vous consentez expressément au préalable à ce que
                le contenu que vous avez acheté vous soit livré avant la fin du
                délai de rétractation et vous perdez ainsi le droit légal de
                rétractation.
              </p>
              <p>
                Kiess Inc peut gérer, réglementer, contrôler, modifier ou
                éliminer les Articles virtuels à tout moment, avec ou sans
                préavis. Dans toute la mesure prévue par la loi applicable,
                Kiess Inc décline toute{" "}
              </p>
              <p>
                responsabilité envers vous ou tout tiers dans le cas où Kiess
                Inc exerce de tels droits.
              </p>
              <p>
                ...
                Service, vous ne devez pas vendre, acheter, racheter ou
                autrement transférer des Articles
              </p>
              <p>
              ...
              <p>
                ...
                encourus par vous ou toute personne utilisant un compte
                enregistré pour vous. Kiess Inc peut réviser à tout moment le
                prix des Articles virtuels
              </p>
              ...
              <p>
                ...
                collecte et le traitement de vos Données Personnelles à
                l’adresse e-mail suivante :{" "}
              </p>
              <p>contact@kiess.fr</p>
              <p>
                Sachez enfin que la Politique de Confidentialité fait partie
                intégrante des Conditions Générales d’Utilisation et qu’à ce
                titre les définitions qui y sont établies sont applicables au
                présent document.
              </p>
              <p>
            ...
            <ul className="ml-7 w-fit list-decimal">
              <li>
                ...
                <p>
                  dont Kiess Inc les utilise et les fonctionnalités proposées
                  pour permettre aux Utilisateurs d’accéder et de mettre à jour
              ...
              <li>
                ...
                <p>
                  En acceptant les CGU, vous confirmez avoir pris connaissance
                  et accepter sans restriction ni réserve la présente Politique
                  de Confidentialité qui en font intégralement partie. En cas de
                ...
                <p>
                  versions de la Politique de Confidentialité sur l’Application
                  et à l’adresse suivante https://Kiess.fr/cgu/ et alertera les
              ...
              <li>
                ...
                <p>
                  ...
                  modifiée (dite Loi Informatique <br /> et Libertés) ainsi
                  qu’au Règlement UE 2016/679 du 27 avril 2016, dit Règlement
                  Général sur la Protection des Données (RGPD).
                </p>
                <p>
                  Selon la réglementation en vigueur, Kiess Inc est le
                ...
                <p>
                  ...
                  finalités explicites et légitimes déterminées dans la
                  Politique de Confidentialité. La durée de traitement n’excède
              ...
              <li>
                ...
                <ul className="ml-9 w-fit list-decimal">
                  <li>
                    <p>
                      Quelles sont les Données Personnelles collectées et
                      comment sont-elles traitées ?
                    </p>

                    <p>
                      Afin de fournir un accès à la Plateforme à ses Services,
                      Kiess Inc est susceptible de collecter plusieurs
                      catégories de Données Personnelles vous concernant, pour
                      des finalités, des bases légales de traitement et
                    </p>
                    <p>
                      des durées de conservation différentes. Nous vous
                      proposons une synthèse de l’ensemble de ces informations
                    ...
                    <p>
                      Durée de l’utilisation des services augmentée de 3 ans
                      après la dernière connexion au service ou jusqu’à la
                      demande suppression
                    </p>
                    ...
                    <p>
                      Durée de l’utilisation des services augmentée de 3 ans
                      après la dernière connexion au service ou jusqu’au retrait
                      du consentement
                    </p>
                    ...
                    <p>
                      Bon fonctionnement de la Plateforme et de ses Services
                    </p>

                    <p>
                      Données relatives à votre activité sur Kiess,
                      Communications avec Kiess, Données relatives aux appareils
                    ...
                    <p>
                      Données envoyées par l’appareil photo de votre téléphone
                      et photos stockées sur votre téléphone
                    </p>
                    ...
                    <p>
                      Durée de l’utilisation des services augmentée de 3 ans
                      après la dernière connexion ou jusqu’au retrait du
                      consentement
                    </p>

                    <p>
                      Gestion administrative de la Plateforme, des réclamations
                      et signalements des Utilisateurs, Modération de contenu
                      conformément à nos CGU
                    </p>

                    <p>
                      Données relatives au contenu, Communications avec Kiess
                      Inc
                    </p>
                    ...
                    <p>
                      Durée de l’utilisation des services + prescription légale
                      (5 ans)
                    </p>
                    ...
                    <ul className="ml-9 w-fit list-decimal">
                      <li>
                        ...
                        <p>
                          ...
                          obligatoirement renseigner à l’ouverture de votre
                          compte : votre numéro de téléphone, nom ou prénom,
                          date de naissance, nom d’utilisateur, et mot de
                        </p>
                        ...
                        <p>
                          ...
                          inappropriés, bugs, erreurs), répondez à un sondage
                          sur la qualité de nos Services, demandez de
                        </p>
                      ...
                      <li>
                        ...
                        <ul className="ml-9 w-fit list-disc">
                          ...
                          <li>
                            <p>
                              Précisions sur les bases légales et les finalités
                              de traitement
                            </p>

                            <p>
                              Nous traitons les Données ci-dessus décrites
                              conformément aux exigences du RGPD pour
                              différentes finalités sur les bases de :
                            </p>

                            <ul className=" w-fit list-disc">
                              <li>
                                <div>
                                  L’exécution contractuelle lorsque le
                                  traitement permet à Kiess Inc de fournir les
                                  Services tels que décrits dans les Conditions
                                  Générales d’Utilisation. Cela inclut :
                                  <ul className="ml-5 w-fit list-disc">
                                    ...
                                    <li>
                                      <p>
                                        La notification des changements apportés
                                        à nos services ;
                                      </p>
                                    </li>
                                ...
                                <ul className="ml-5 w-fit list-disc">
                                  <li>
                                    <p>
                                      ...
                                      messages et métadonnées associées à des
                                      fins administratives et de vérification
                                      leur conformité à nos Conditions Générales
                                      d’Utilisation ;
                                    </p>
                                  </li>
                                  ...
                                  <li>
                                    <p>
                                      ...
                                      d’utilisation de la Plateforme par les
                                      Utilisateurs à des fins d’amélioration, de
                                      développement et de promotion commerciale
                                      de l’Application ;
                                    </p>
                                  </li>
                                  ...
                                  <li>
                                    <p>
                                      L’identification d’activités criminelles,
                                      de comportement frauduleux, d’utilisation
                              ...
                              <li className=" list-disc">
                                <p>
                                  Nos obligations légales lorsque le traitement
                                  de Données vise à prévenir et lutter contre
                                  les activités abusives, frauduleuses, et
                                  illégales.
                                </p>
                              </li>
                              ...
                              <li>
                                <p>
                                  ...
                                  sur des Données de votre carnet de contact.
                                  Cela inclut :
                                </p>
              ...
              <div className="w-fit">
                ...
                <p>
                  ...
                  ligne. Un cookie permet à son émetteur d’identifier le
                  terminal dans lequel il est enregistré, pendant la durée de
                  validité ou d’enregistrement du cookie.
                </p>
                <p>
                  Le cookie ne permet donc pas d’identifier l’Utilisateur en
                  tant que tel ; il sert à enregistrer vos informations de
                  navigation sur la Plateforme.
                </p>
                <p>
                  Lorsque vous vous connectez sur la Plateforme, des
                  informations relatives à votre navigation sont susceptibles
                  d’être enregistrées dans des fichiers « Cookies » installés
                  sur votre terminal, selon les choix que{" "}
                </p>
                <p>
                  vous avez pu exprimer concernant les cookies et qui reste
                  modifiable à tout moment. Ces cookies permettent une
                  navigation personnalisée et sont également utilisés à des fins
                  analytiques (mesures d’audience).
                </p>
                <p>
                ...
                <p>
                  ...
                  nécessitent en général votre consentement préalable, auquel
                  cas il est recueilli par un clic sur « J’accepte ». L’accord
                  donné pour l’utilisation de cookies a une
                </p>
                <p>
                ...
                <p>
                  ...
                  Inc décline toute responsabilité pour les conséquences liées
                  au fonctionnement{" "}
                </p>
                <p>
                  dégradé de ses Prestations résultant de l’impossibilité pour
                  Kiess Inc d’enregistrer ou de consulter les cookies
                  nécessaires au bon fonctionnement de la Plateforme et que vous
              ...
              <ul className=" ml-8 w-fit list-disc">
                <li>
                  <div>
                    ...
                    <ul className=" w-fit list-disc">
                      ...
                      <li className="ml-5">
                        <p>
                          les cookies analysant votre utilisation de
                          l’Application afin de générer des rapports
                          statistiques, sans vous identifier :
                        </p>
                        <li className="ml-10">
                          {" "}
                        ...
                        <li className="ml-5">
                          <p>
                            ...
                            efficace de l’Application, par exemple en
                            sauvegardant vos préférences d’utilisation.
                          </p>
                        </li>
                      </li>
                    </ul>
                ...
                <li className="ml-5">
                  <p>
                    les cookies analysant votre utilisation du site internet
              ...
              <li>
                ...
                <p>
                  Toute utilisation de Données Personnelles dans un but autre
                  que ceux exposés ci-dessus dans nos Règles de Confidentialité
                  nécessitera l’accord préalable exprès de l’Utilisateur.
                </p>

                <p>
                  Kiess Inc s’engage à conserver les Données Personnelles des
                  Utilisateurs uniquement pendant la durée strictement
                  nécessaire au(x) traitement(s) déclaré(s) selon les finalités
                  précitées ou à l’exercice et à la
                </p>
                ...
                <p>
                  ...
                  bases de données à l’issue de ces différentes durées. En cas
                  de demande de suppression de votre compte, celle-ci sera
                  effective sous 30 (trente) jours
                </p>
                ...
                <p>
                  Toutefois, Kiess Inc peut conserver certaines informations
                  pour une période postérieure à la clôture du compte personnel
                  de l’Utilisateur afin de satisfaire à des obligations légales,
                  comptables et fiscales et{" "}
                </p>

                <p>
                  notamment, afin de prévenir d’éventuels comportements
                  illicites après la suppression d’un Compte Utilisateur
                  (réutilisation d’un ancien compte par un tiers). Dans cette
                  hypothèse, les Données Personnelles
                </p>

                <p>
                  {" "}
                  seront désactivées et ne seront plus accessibles en ligne.
                </p>
              </li>
              <li>
                <p>Partage d’informations avec des tiers</p>
                <p>
                  1. Absence de communication des Données Personnelles à des
                  tiers
                </p>

                <p>
                  A l’exception des Contenus sur lesquels vous nous avez
                  concédés une licence d’utilisation conformément aux
                  dispositions des Conditions générales d’utilisation, Kiess Inc
                ...
                <p>
                  ...
                  échéant, être transmises à des tiers sous-traitants
                  intervenant dans la fourniture des Services (prestataires
                  techniques et d’hébergement, envoie de{" "}
                </p>
                ...
                <p>
                  Kiess Inc s’engage à ne communiquer les Données Personnelles
                  des Utilisateurs qu’à des prestataires habilités et de
                  confiance, qui les traitent pour notre compte, selon nos
                  instructions, conformément aux
                </p>

                <p>
                  présentes Règles de Confidentialité et dans le respect de
                  toute autre mesure appropriée de sécurité et de
                  confidentialité.
                </p>
                ...
                <p>
                  ...
                  décrites dans les Règles de Confidentialité implique parfois
                  de transférer vos Données dans un ou plusieurs autres pays, à
                ...
                <p>
                  ...
                  et/ou tout autre mécanisme approuvé par la Commission
                  Européenne pour conserver un niveau de protection de vos
                ...
                <p>
                  Les informations et Données Personnelles pourront également
                  être divulguées à un tiers si Kiess Inc y est contraint par la
                  loi, une disposition réglementaire, ou une ordonnance
                  judiciaire, ou encore si cette{" "}
                </p>
                  ...
                  <ul className="ml-10 w-fit list-disc">
                    <li>
                      <p>
                        ...
                        vigueur, y compris pour constater d’éventuels
                        manquements à celles-ci ;
                      </p>
                    </li>
                    ...
                    <li>
                      <p>
                        ...
                        ou à la sécurité de ses utilisateurs, en application et
              ...
              <div className="w-fit">
                ...
                <p>
                  sont traitées de manière sécurisée dans le respect des Règles
                  de Confidentialité. Cependant, la transmission d’informations
                  via Internet comporte des risques irréductibles qui ne
                  permettent pas de garantir une{" "}
                </p>
                <p>
                  parfaite sécurité des informations transmises via la
                  Plateforme. En conséquence, toute transmission de Données
                  Personnelles est réalisée à vos propres risques.
                </p>
              </div>
              <li>
                ...
                <div>
                  ...
                  <ul className="ml-10 w-fit list-decimal">
                    <li>
                      <p>
                        Droit d’accès : il vous permet d’accéder gratuitement
                        aux Données Personnelles collectées à votre égard.
                      </p>
                    </li>
                    ...
                    <li>
                      <p>
                        ...
                        traitement des Données Personnelles n’est plus
                        nécessaire au regard des finalités pour lesquelles elles
                        ont été collectées ou, le cas échéant,
                      </p>
                      <p>
                        {" "}
                    ...
                    <li>
                      <p>
                        Droit d’opposition à la collecte et au traitement de
                        tout ou partie de vos Données Personnelles : ce droit
                        n’est pas absolu et ne s’applique qu’aux Données
                        Personnelles collectées à des fins de prospection
                      </p>
                        ...
                        <ul className="ml-10 w-fit list-disc">
                          <li>
                            <p>
                              ...
                              vertu du droit de rectification décrit au 8.2.
                              Vous pouvez alors demander l’arrêt du traitement
                              de vos Données Personnelles pendant la durée
                              nécessaire à
                            </p>
                ...
                <p>
                  ...
                  confirmer quelques informations de votre Compte afin de
              ...
              <li>
                ...
                <p>
                  Kiess n’est pas destiné aux mineurs de moins de 13 ans. Si
                  vous pensez que nous avons des Données Personnelles concernant
                  un enfant ou qui ont été collectées auprès d’un enfant n’ayant
                  pas l’âge requis,
                </p>
              ...
              <li>
                ...
                <p>
                  Cette clause n’est valide et juridiquement contraignante que
                  si vous êtes partie aux Conditions Générales d’Utilisation de
                ...
                <p>
                  À la lumière de la loi californienne sur la protection de la
                  vie privée des consommateurs de 2018 (“CCPA”), nous vous
                  fournissons cette information en tant que fournisseur de
                  services amené à traiter vos{" "}
                </p>
                ...
                <p>
                  ...
                  de Virginie sur la protection des données des consommateurs
                  (SB 1392).
                </p>
                ...
                <p>
                  ...
                  ou de la Politique de confidentialité, ces dernières feront
                  foi en ce qui concerne les Données des personnes dans l’Espace
                  économique
                </p>
                ...
                <p>
                  ...
                  américaine chez Kiess Inc ou pour exercer vos droits à ce
                  titre, vous pouvez nous contacter tel qu’indiqué à l’article
                  11.
                </p>
              </li>
